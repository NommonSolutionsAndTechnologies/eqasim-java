...
public class LATract {
	...
	public LATract(Geometry geometry) {
	...
	public static Set<LATract> read(File path) throws MalformedURLException, IOException {
		...
		Set<LATract> iris = new HashSet<>();

		while (featureIterator.hasNext()) {
			SimpleFeature feature = featureIterator.next();
			Geometry geometry = (Geometry) feature.getDefaultGeometry();
			iris.add(new LATract(geometry));
		}
